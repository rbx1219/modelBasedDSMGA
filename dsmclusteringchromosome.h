...
class DSMClusteringChromosome
{
    public:
        ...
        void createDSMmu (Chromosome * population, int populationSize, int selectionPressure, int *selectionIndex);
        void createDSMmu_enfe (Chromosome * population, int populationSize, int selectionPressure, int *selectionIndex);
        void createDSM_beta_enfe (Chromosome * population, int populationSize, int selectionPressure, int *selectionIndex);
        ...
        double computeTCONV (double, double) const;
